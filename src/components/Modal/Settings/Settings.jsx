...
const Settings = () => {
  ...
  return <React.Fragment key={language}>
    ...
    <S.ModalText>
      ...
      <S.ModalLink href={'https://www.linkedin.com/in/paul-courtois/'} target="_blank">
        Paul Courtois
      </S.ModalLink>.
    </S.ModalText>
    <S.ModalText>
    ...
    <S.ModalText>
      ...
      <S.ModalLink href={'https://fr.wikipedia.org/wiki/Michel_Morvan_(linguiste)'} target="_blank">
        Michel Morvan
      </S.ModalLink>.
    </S.ModalText>
    <S.ModalText>
      {t('settings.foundError')}
      <S.ModalLink href={'mailto:paulcourtoispaul@gmail.com'} target="_blank">
        paulcourtoispaul@gmail.com
      </S.ModalLink>
    </S.ModalText>
  </React.Fragment>
};
